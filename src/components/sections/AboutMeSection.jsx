    ...
    return (
        <Container className='margin-top-10'>
            ...
            <Row className='align-items-top justify-content-between'>
                ...
                <Col lg={6} sm={12}>
                    <p className='main-white roboto-regular w-75 text-justify mx-auto fs-5'>Hi! My name is <span className='clear-blue-color'>Naomi</span>, I'm 25 years old and I'm a software developer. I enjoy web development and design, but as a creative person I have other hobbies too. I consider myself a nerd, and I enjoy spending time searching tools and gadgets to <span className='clear-blue-color'>improve my work and organization</span> related and non-related to my studied field.</p>
